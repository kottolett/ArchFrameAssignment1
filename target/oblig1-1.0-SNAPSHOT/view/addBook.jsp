    ...
    <div class="row my-5">
        <div class="col-sm-6 mx-auto">
            ...
            <form:form method="post" action="/saveBook" modelAttribute="book">
                ...
                <div class="form-group">
                    <label for="FormControlSelect">Select Author:</label>
                    <form:select class="form-control" id="FormControlSelect" name="author" path="author">
                    <c:forEach items="${authors}" var="author">
                        <form:option value="${author.id}">${author}</form:option>
                    </c:forEach>
                    </form:select>
                </div>
